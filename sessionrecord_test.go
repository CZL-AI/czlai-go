...
func TestSessionRecordHistoryWithOptionalParams(t *testing.T) {
	...
	err := client.SessionRecords.History(context.TODO(), czlai.SessionRecordHistoryParams{
		Content:     czlai.F("content"),
		ModuleType:  czlai.F(int64(0)),
		Role:        czlai.F("role"),
		SessionID:   czlai.F("session_id"),
		ContentType: czlai.F(int64(0)),
		Stage:       czlai.F(int64(0)),
	})
	if err != nil {
