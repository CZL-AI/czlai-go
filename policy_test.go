...
func TestPolicyPolicyInfoWithOptionalParams(t *testing.T) {
	...
	err := client.Policies.PolicyInfo(context.TODO(), czlai.PolicyPolicyInfoParams{
		Keys:       czlai.F("keys"),
		PolicyType: czlai.F(int64(0)),
	})
	if err != nil {
