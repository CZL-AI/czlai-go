...
func TestAITrialOptionsWithOptionalParams(t *testing.T) {
...
func TestAITrialQuestionWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.AITrials.Question(context.TODO(), czlai.AITrialQuestionParams{
		ServiceType: czlai.F(int64(0)),
		SessionID:   czlai.F("session_id"),
	})
	if err != nil {
