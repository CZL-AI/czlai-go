...
func TestUserAgentHeader(t *testing.T) {
	...
	client.AICheckup.SessionStart(context.Background())
	if userAgent != fmt.Sprintf("Czlai/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.AICheckup.SessionStart(context.Background())
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.AICheckup.SessionStart(cancelCtx)
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.AICheckup.SessionStart(deadlineCtx)
		if err == nil || res != nil {
