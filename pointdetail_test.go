...
func TestPointDetailGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.PointDetails.Get(context.TODO(), czlai.PointDetailGetParams{
		IsAdd: czlai.F(czlai.PointDetailGetParamsIsAdd0),
